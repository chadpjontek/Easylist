  ...
  e.waitUntil(
    caches.open(staticCacheName).then(cache =>
      cache.addAll([
        ...
        '/CreateList~EditList~List~ListCopy~SharedList~SignIn~ViewLists.bundle.js',
        '/Donate.bundle.js',
        '/EditList.bundle.js',
        '/Home.bundle.js',
        '/List.bundle.js',
        ...
        '/SignIn.bundle.js',
        '/SignUp.bundle.js',
        '/vendors~CreateList~EditList~List~ListCopy~SharedList~SignIn~ViewLists.bundle.js',
        '/ViewLists.bundle.js',
        '/images/bold.svg',
        '/images/checkbox.svg',
